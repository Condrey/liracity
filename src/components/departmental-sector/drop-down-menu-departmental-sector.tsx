...
export default function DropDownMenuDepartmentalSector({ sector, className }: DropDownMenuDepartmentalSectorProps) {
	...
	return (
		<>
			...
			/>
			<DeleteDepartmentalSectorDialog open={openDelete} setOpen={setOpenDelete} departmentalSector={sector} />
			<FormAddEditEmployee open={openCreate} setOpen={setOpenCreate} departmentalSectorId={sector.id} />
		</>
	);
}
