...
var q = (function () {
	...
	return function (n, i, o, s, a, l) {
		var f,
			...
			$ = i.d;
		if (!Y || !Y[0] || !$ || !$[0])
			return new ar(!n.s || !i.s || (Y ? $ && Y[0] == $[0] : !$) ? NaN : (Y && Y[0] == 0) || !$ ? an * 0 : an / 0);
		for (
					...
					((v = 0),
						...
						f < 0
							? ((ae = k[0]),
								...
								D < F && R.unshift(0),
								r(k, R, F, l),
								f == -1 && ((F = k.length), (f = t($, k, ue, F)), f < 1 && (v++, r(k, ue < F ? sr : $, F, l))),
								(F = k.length))
							: f === 0 && (v++, (k = [0])),
						(B[h++] = v),
...
function Gn(e, t) {
	let r = e._extensions.getAllModelExtensions(t) ?? {},
		n = [Ic(e, t), Dc(e, t), Vt(r), ee("name", () => t), ee("$name", () => t), ee("$parent", () => e._appliedParent)];
	return pe({}, n);
}
function Ic(e, t) {
	let r = Ee(t),
	...
	class t {
		...
		constructor(n) {
			...
			let o = e.relativeEnvPaths && {
					rootEnvPath: e.relativeEnvPaths.rootEnvPath && fr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
					schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && fr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath)
				},
				s;
			if (n?.adapter) {
				s = n.adapter;
