...
function it(t, e) {
	...
	if ((e == null ? ((q = !1), (h = I)) : (h = e), A.eq(10))) return (e == null && (q = !0), vr(S, h));
						...
						((T = 0),
							...
							a < 0
								? ((oe = S[0]),
									...
									k < I && C.unshift(0),
									r(S, C, I),
									a == -1 && ((I = S.length), (a = e(U, S, se, I)), a < 1 && (T++, r(S, se < I ? St : U, I))),
									(I = S.length))
								: a === 0 && (T++, (S = [0])),
							(O[h++] = T),
			...
			for (var Se = z.length - 1; a < o - 3; )
				for (
					...
					((O = z[f]),
						...
						(h = O));
			for (; a < o; )
				for (I = r.charCodeAt(s + (h = a)), A = ++a, f = 0; f < Se; f += 2)
					((O = z[f]), (z[f] = A = t(O, h, A, I, z[f + 1])), (h = O));
			return A;
		};
	})();
});
...
var Ys = { red: qe, gray: Dn, dim: Lt, bold: _t, underline: Sn, highlightSource: (t) => t.highlight() },
	Xs = { red: (t) => t, gray: (t) => t, dim: (t) => t, bold: (t) => t, underline: (t) => t, highlightSource: (t) => t };
...
function jr(t, e) {
	t === void 0 &&
		e.isPreviewFeatureOn("strictUndefinedChecks") &&
		e.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: e.getSelectionPath(), underlyingError: Si });
}
var Vr = class t {
	constructor(e) {
		this.params = e;
...
var tn,
	ho = {
		async loadLibrary(t) {
			...
			if (r === void 0)
				throw new M(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Re().prettyName})`, e);
...
`);
	...
	let k = { accelerate: f, ppg: h, driverAdapters: T };
	function A(O) {
		return O.length > 0;
	}
	return A(o)
		...
		_request(n) {
			...
			let i = n.middlewareArgsMapper ?? $l,
				...
				f = async (h) => {
					...
					if (T) return this._tracingHelper.runInChildSpan(s.middleware, (I) => T(h, (oe) => (I?.end(), f(oe))));
