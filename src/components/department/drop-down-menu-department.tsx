...
export default function DropDownMenuDepartment({ department }: DropDownMenuDepartmentProps) {
	...
	return (
		<>
			...
			<FormAddEditDepartment open={openEditDialog} setOpen={setOpenEditDialog} departmentToEdit={department} />
			<DeleteDepartmentDialog open={openDeleteDialog} setOpen={setOpenDeleteDialog} department={department} />
