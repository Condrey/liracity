...
export default function ButtonAddEditEmployee({employee,departmentalSectorId,...props}:ButtonAddEditEmployeeProps){
 ...
 title={employee?`Update ${employee.user.name!.split(" ").pop()}'s information`:'Create new staff'}
  {...props}/>
<FormAddEditEmployee open={open} setOpen={setOpen} employee={employee}  departmentalSectorId={departmentalSectorId}/>
 </>
}