...
export default function FormAddEditDepartment({ open, setOpen, departmentToEdit }: FormAddEditDepartmentProps) {
	...
	return (
		<ResponsiveDrawer open={open} setOpen={setOpen} title={departmentToEdit ? "Update department" : "Add department"}>
			<Form {...form}>
