		...
		>
			<ToggleGroup type="multiple" className="button-group" size="sm">
				...
				<ToggleGroupItem
					...
					className={
						editor.isActive("bold") ? "is-active bg-primary text-primary-foreground" : "bg-card text-card-foreground"
					}
				>
				...
				<ToggleGroupItem
					...
					className={
						editor.isActive("italic") ? "is-active bg-primary text-primary-foreground" : "bg-card text-card-foreground"
					}
				>
