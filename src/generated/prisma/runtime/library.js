...
var ds = ne((Fg, ps) => {
	...
	ps.exports = { supportsHyperlink: bi, stdout: bi(process.stdout), stderr: bi(process.stderr) };
});
var ms = ne((Kg, Vc) => {
	Vc.exports = {
		...
		dependencies: {
			...
			"@prisma/prisma-schema-wasm": "6.11.0-18.9c30299f5a0ea26a96790e13f796dc6094db3173",
			"@prisma/schema-engine-wasm": "6.11.0-18.9c30299f5a0ea26a96790e13f796dc6094db3173",
...
var xi = ne((th, Qc) => {
	Qc.exports = {
		...
		license: "Apache-2.0",
		author: "Tim Suchanek <suchanek@prisma.io>",
		prisma: { enginesVersion: "9c30299f5a0ea26a96790e13f796dc6094db3173" },
		repository: {
			type: "git",
		...
		return function (r, t) {
			...
			for (; a < o; )
				for (I = t.charCodeAt(s + (u = a)), f = ++a, l = 0; l < me; l += 2)
					((g = D[l]), (D[l] = f = e(g, u, f, I, D[l + 1])), (u = g));
			return f;
		};
	})();
});
...
${c}`);
	...
	return r === "linux" && o && i
		? `${o}-openssl-${i}`
		: (r !== "linux" && Jt(`Prisma detected unknown OS "${r}" and may not work as expected. Defaulting to "linux".`),
...
var zt = globalThis.window?.document !== void 0,
	...
	bg = globalThis.Deno?.version?.deno !== void 0,
	Eg = globalThis.process?.versions?.electron !== void 0,
...
function Si(e) {
	let r = e.e,
		...
		i = `Please refer to the documentation about Prisma's system requirements: ${Ei("https://pris.ly/d/system-requirements")}`,
					...
					((d = 0),
						...
						u < 0
							? ((me = b[0]),
								...
								I < D && h.unshift(0),
								t(b, h, D, l),
								u == -1 && ((D = b.length), (u = r(_, b, H, D)), u < 1 && (d++, t(b, H < D ? fr : _, D, l))),
								(D = b.length))
							: u === 0 && (d++, (b = [0])),
						(S[p++] = d),
...
var bd = { red: ce, gray: Hr, dim: Ie, bold: W, underline: Y, highlightSource: (e) => e.highlight() },
	Ed = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function Nn({
	...
	return { modelName: e, action: Xd[r], query: Et(t, p) };
}
...
`);
	return r.reduce(function (t, n) {
		var i = fm(n) || hm(n) || Em(n) || Pm(n) || xm(n);
		return (i && t.push(i), t);
	}, []);
}
var dm =
...
function ao(e, r) {
	let t = e._extensions.getAllModelExtensions(r) ?? {},
		n = [Lm(e, r), Mm(e, r), xt(t), re("name", () => r), re("$name", () => r), re("$parent", () => e._appliedParent)];
	return he({}, n);
}
function Lm(e, r) {
	let t = Se(r),
...
${a.backtrace}`,
	...
	async requestBatch(r, { transaction: t, traceparent: n }) {
		...
		((this.lastQuery = JSON.stringify(i)),
			(this.executingQueryPromise = this.engine?.query(this.lastQuery, JSON.stringify({ traceparent: n }), _l(t))));
...
function $l({ url: e, adapter: r, copyEngine: t, targetBuildType: n }) {
	let i = [],
		...
		a = (g) => {
			let h = g.join(`
`);
			o.push({ _tag: "error", value: h });
		},
		l = !!e?.startsWith("prisma://") || !t,
		u = nn(e),
		c = !!r,
		p = l || u;
	(!c &&
	...
	let d = { accelerate: l, ppg: u, driverAdapters: c };
	function f(g) {
		return g.length > 0;
	}
	return f(o)
		? { ok: !1, diagnostics: { warnings: i, errors: o }, isUsing: d }
		: { ok: !0, diagnostics: { warnings: i }, isUsing: d };
}
	...
	class r {
		...
		constructor(n) {
			...
			let o = e.relativeEnvPaths && {
					...
					schemaEnvPath:
						e.relativeEnvPaths.schemaEnvPath && ei.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath)
				},
				s;
			if (n?.adapter) {
				s = n.adapter;
